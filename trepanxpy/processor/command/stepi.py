# -*- coding: utf-8 -*-
#  Copyright (C) 2009, 2013, 2015, 2020, 2025 Rocky Bernstein
#
...
class StepICommand(DebuggerCommand):
    ...
    def run(self, args: list[str]) -> bool:
        ...
        if len(args) <= 1:
            ...
            pos = 1
            if pos == len(args) - 1:
                core.step_ignore = proc.get_int(args[pos], default=1, cmdname="step")
        ...
        core.step_flags = proc.vm.frame.event_flags = PyVMEVENT_ALL
